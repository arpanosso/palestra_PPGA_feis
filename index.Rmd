...
Resumo da análise ondem são apresentados a desvio padrão de cada componente, juntamente com a porcentagem da variação explicada individual e acumulada.
...
```{r}
# Screeplot, para verificar os PCs maiores que a Unidade, de acordo com Kaiser (1958), valores maiores que 1.
screeplot(pca)
abline(h=1,lty=2)
